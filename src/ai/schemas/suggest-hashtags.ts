...
export const SuggestHashtagsInputSchema = z.object({
  ...
  natureOfBusiness: z.string().describe("The nature/type of the business."),
  ...
  servicesProducts: z
    .string()
    .describe("The services or products offered by the business."),
  generatedContentPlan: z
    .string()
    .describe("The generated content plan for the business."),
});
